...
for file_i in [6333]:
	...
	b = removePoints(a,bc)
	rgb_map = makeBVFeature(b, bc , 0.078125)
	...
	model = torch.load('model/ComplexYOLO_epoch150')
	model.cuda()
	...
	img = cv2.imread('predict/eval_bv.png')
	...
	for j in range(50):
        ...
        misc.imsave('predict/eval_gt_bv.png', img)   
